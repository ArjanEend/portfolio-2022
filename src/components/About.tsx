        ...
        <div id='about' className="w-full lg:h-screen p-8 lg:p-16 flex items-center py-16">
            <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
                <div className='col-span-2'>
                    ...
                    <p className='py-2 text-gray-700'>Creative Software Engineer & Skater Boi</p>
                ...
                <div className='w-full h-auto m-auto flex items-center justify-center border-black border-8 hover:scale-105 ease-in duration-300'>
